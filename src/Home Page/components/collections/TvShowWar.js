...
import { getTvShowWar } from '../../../redux/getMovie/getTvShowSlice';
import { getInfo, modalType } from '../../../redux/movieModal/modal';

const TvShowWar = ({setInfo}) => {

  const dispatch = useDispatch()
  const tvWar = useSelector(state => state.tv.tvWar)
    ...
    return (
        <div className="movie-list-wrapper">
          <ul className="movie-list" ref={movieListRef}>
            ...
            {tvWar.map((item , index)=>(
              <li className="movie-item" key={index}>
              <img className="movie-item-img" src={serc + item.poster_path} alt="" />
              <div className="movie-item-info">
                ...
                <div className="movie-item-buttons">
                  ...
                  <button><AiFillLike className='movie-item-buttons-i' /></button>
                  <button><AiFillDislike className='movie-item-buttons-i'/></button>
          ...
          <MdOutlineArrowBackIos style={arrowStyle} onClick={handleScrollBack} className='arrow-back'/>
